...
export const ProjectIcon: FC<TIcon> = ({ extraClass }) => {
  return(
    <svg className={extraClass} width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
      <g clipPath="url(#clip0_9901_123)">
